...
if __name__ == "__main__":
    ...
    adjacency_phi = adjacency_matrix("2", N)
    ...
    # makeplot_animation_only_agents(X,V,N,T,h,Z,SAVEFIG=True,filename_template="animation_only_agents_basic_model")
    # make_plot_snapshot_only_agents(X, V, N, [0, 150, 300], h, Z, SAVEFIG=True, filename_template="snapshot_only_agents_basic_model")
    # make_plot_snapshot_energy(X, V, adjacency_phi, beta, h, Z, M, SAVEFIG=True,filename_template="snapchot_energy_basic_model")
    # make_plot_snapshot_agents_energy(X, V, adjacency_phi, beta, h, Z, M, [0, 150, 300], SAVEFIG=False)
    # make_plot_minimum_distance(X,h,SAVEFIG=True,filename_template="plot_minimum_distance_baic_model")
    # make_plot_maximal_velocity_difference(V,h,SAVEFIG=True,filename_template="plot_maximal_velocity_difference_basic_model")
    # make_plot_animation_agents_energy(X,V,adjacency_phi,beta,h,Z,M,SAVEFIG=True,filename_template="animation_agents_energy_basic_model")
    # make_plot_animation_agents_velocity(X, V, h, Z, SAVEFIG=True, filename_template="animation_agents_velocity_basic_model")
    # make_plot_animation_agents_min_distance(X, V, h, Z, SAVEFIG=True,filename_template="animation_agents_distance_basic_model")